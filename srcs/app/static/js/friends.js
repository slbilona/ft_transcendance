...
//                     <button class="nav-link active custom-tab-button" id="friend-list-tab" data-bs-toggle="pill" data-bs-target="#friend-list" type="button" role="tab" aria-controls="friend-list" aria-selected="true">Liste d'amis</button>
//                 </li>
//                 <li class="nav-item" role="presentation">
//                     <button class="nav-link custom-tab-button" id="add-friend-tab" data-bs-toggle="pill" data-bs-target="#add-friend" type="button" role="tab" aria-controls="add-friend" aria-selected="false">Ajouter un ami</button>
//                 </li>
//             </ul>
//         </div>
